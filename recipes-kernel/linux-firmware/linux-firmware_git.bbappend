...
do_install_append() {
	...
	install -m 0644 iwlwifi-7265D-29.ucode ${D}${FWPATH}
	install -m 0644 rtlwifi/rtl8723bs_nic.bin ${D}${FWPATH}/rtlwifi
	install -m 0644 rtlwifi/rtl8723bs_wowlan.bin ${D}${FWPATH}/rtlwifi
...
RDEPENDS_${PN}-iwlwifi-7265d-29 = "${PN}-iwlwifi-license"
FILES_${PN}-iwlwifi-7265d-29 = " \
